      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 mb-24">
          <div className="flex-1">
            <h1 className="text-7xl font-bold font-display tracking-tighter mb-4">
              Kingsley Etim
            </h1>
            <p className="text-2xl text-emerald-500 font-bold uppercase tracking-[0.2em] mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-20">
                ...
                {EXPERIENCES.map((exp, idx) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-2 gap-2">
                      ...
                      <span className="text-emerald-500 font-black text-[10px] uppercase tracking-[0.2em] glass px-3 py-1 rounded-full">
                        {exp.period}
                      </span>
                    </div>
                    <h4 className="text-white/60 font-bold mb-6 uppercase text-xs tracking-[0.2em]">
                      {exp.company}
                    </h4>
              ...
              <div className="space-y-12">
                <div className="relative pl-10 border-l-2 border-zinc-800">
                  ...
                  <p className="text-emerald-500 font-bold text-xs uppercase tracking-widest mb-2">
                    B.Eng in Civil Engineering • 2017 - 2022
                  </p>
                  <p className="text-zinc-400">
                    Successfully completed the Bachelor's degree with a focus on
                ...
                <div className="relative pl-10 border-l-2 border-zinc-800">
                  ...
                  <p className="text-emerald-500 font-bold text-xs uppercase tracking-widest mb-2">
                    Animator Certification • Oct 2024
                  </p>
                  <p className="text-zinc-400">
                    Intensive specialization in video editing and 3D animation
                    systems.
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-16">
            ...
            <section className="bg-emerald-500/5 p-10 rounded-[40px] border border-emerald-500/20 relative overflow-hidden group">
              ...
              <h3 className="text-xl font-bold mb-6 font-display uppercase tracking-widest relative z-10">
                Distinctions
              </h3>
