    ...
    <section className="py-40 relative border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-24">
          <span className="text-[#CC9933] font-black uppercase tracking-[0.4em] text-xs mb-4 block">
            Ecosystem
          </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          {[
            ...
            <motion.div
              ...
              className="group p-10 glass rounded-[40px] hover:bg-[#CC9933]/5 transition-colors border border-white/5"
            >
              <div className="w-16 h-16 bg-zinc-900 rounded-2xl flex items-center justify-center mb-8 border border-white/5">
                <service.icon className="w-8 h-8 text-[#CC9933]" />
              </div>
              <h3 className="text-2xl font-bold mb-4 font-display transition-colors group-hover:text-[#CC9933]">
                {service.title}
              </h3>
