...
export const PROJECTS: Project[] = [
  {
    ...
    category: "Content and Video Edits",
    thumbnail:
      "https://images.unsplash.com/photo-1536240478700-b869070f9279?auto=format&fit=crop&q=80&w=800",
    description:
      "Developed cinematic teasers and video animations for product launches and ecosystem updates.",
  ...
  },
  {
    ...
    description:
      "Curating stunning visuals and motion assets for social media announcements.",
    client: "Cutoshi",
    year: "2024",
  ...
  },
  {
    ...
    description:
      "High-end video animations to promote partner projects and internal ecosystem growth.",
  ...
  },
  {
    ...
    description:
      "Content development and instruction for onboarding the next generation of Web3 talent.",
    client: "Chaindustry",
    year: "2021",
